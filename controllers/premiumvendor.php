<?php
Class Premiumvendor extends Theme {
    public static $page_data = array('title' => 'premiumvendor');
    public static $partial = 'premiumvendor';
    public static function init_data() {
        global $config;
        parent::init_data();
        if (isset(self::$page_data['title']) && self::$page_data['title'] !== '') {
            parent::$data['title'] = ucfirst(__('premiumvendor')) . ' . ' . $config->site_name;
        }
        parent::$data['name']   = self::$partial;
        parent::$data['premiumvendor'] = self::abc();
    }
