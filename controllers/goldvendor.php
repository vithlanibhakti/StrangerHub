<?php
Class Goldvendor extends Theme {
    public static $page_data = array('title' => 'goldvendor');
    public static $partial = 'goldvendor';
    public static function init_data() {
        global $config;
        parent::init_data();
        if (isset(self::$page_data['title']) && self::$page_data['title'] !== '') {
            parent::$data['title'] = ucfirst(__('goldvendor')) . ' . ' . $config->site_name;
        }
        parent::$data['name']   = self::$partial;
        parent::$data['goldvendor'] = self::abc();
    }
