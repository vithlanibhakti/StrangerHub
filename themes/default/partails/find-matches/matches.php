...
<div class="mtc_usrd_content" data-id="<?php echo $matche->id;?>" <?php if($matche_first === false){?> style="display: none;"<?php }?>>
   ...
   if($matche->language){?>
     ...
     <?php }		
	$name=$matche->username;
    include("config.php");
	$sql=mysqli_query($con,"SELECT id from users where username='$name'");
   ...
   <!--<a href='readvideos.php?username=<?php echo $name ?>' class="btn waves-effect">Video</a>

   <a href="<?php echo $site_url;?>/@<?php echo $matche->username;?>"
   data-ajax="/@<?php echo $matche->username;?>" class="btn waves-effect">Video</a>
   -->
	<div class="bs-example"> 
            ...
            <!--<iframe id="Geeks3" width="450" height="350" src='".$location."' controls width='320px' height='200px'
