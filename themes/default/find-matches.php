...
//echo $guest;
include("config.php");
$sql=mysqli_query($con,"SELECT role,id from users where username='$guest'");
        ...
        <div class="col s12 m3 custom_fixed_element">
            ...
            <div class="dt_user_profile">
                <div class="dt_user_info">
                    <div class="avatar">
                        <?php if(is_avatar_approved($profile->id, str_replace(array($config->uri . '/'),array(''),$profile->avater->full))) { ?>
                        ...
                        <div class="dt_usr_undr_rvw">
                            <img src="<?php echo $config->uri . '/upload/photos/d-blog.jpg'; ?>"
                                alt="<?php echo $profile->full_name; ?>" class="responsive-img" />
                            <span><?php echo __('Under Review');?></span>
                        </div>
                        <?php } ?>
                        <div class="dt_chng_avtr">
                            <span class="btn-upload-image"
                                onclick="document.getElementById('profileavatar_img').click(); return false">
                                ...
                                </svg> <?php echo __( 'Change Photo' );?>
                            </span>
                            <input type="file" id="profileavatar_img" class="hide"
                                accept="image/x-png, image/gif, image/jpeg" name="avatar">
                        </div>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo $site_url;?>/popularity" data-ajax="/popularity">
                                ...
                                <span style="display: inline-block;"><?php echo __( 'Popularity' );?> </span><span
                                    class="bold"
                                    style="margin: 0px 5px;color: #a33596;display: inline-block;"><?php echo GetUserPopularity($profile->id);?></span>
            ...
            <div class="dt_user_profile">
                <div class="dt_user_prof_complt">
                    <h5 class="valign-wrapper">
                        <?php echo __( 'Profile Completion' );?><span><?php echo $profile->profile_completion;?>%</span>
                    </h5>
                    <div class="progress">
        ...
        <div class="col s12 m9">
            ...
            <div class="dt_user_profile dt_how_to_verfy_alrt">
                <span>
                    ...
                    </svg> <?php echo __( 'To get your profile verified you have to verify these.');?>
                </span>
                <ul class="browser-default dt_prof_vrfy">
                    <?php if($config->emailValidation == "1"){?>
                    <?php if( $config->sms_or_email === 'mail' ){?>
                    <?php if( $profile->active === "0" ){?>
                    <li><?php echo __( 'Please verify your email address' );?> <a
                            href="<?php echo $site_url;?>/verifymail"
                            data-ajax="/verifymail"><?php echo __( 'Verify Now' );?></a>.</li>
                    <?php } ?>
                    <?php } ?>
                    <?php if( $config->sms_or_email == 'sms' ){?>
                    <?php if( !empty( $profile->phone_number ) && $profile->phone_verified == "0" ){?>
                    <li><?php echo __( 'Please verify your phone number' );?> <a
                            href="<?php echo $site_url;?>/verifyphone"
                            data-ajax="/verifyphone"><?php echo __( 'Verify Now' );?></a>.</li>
                    <?php } ?>
                    <?php } ?>
                    <?php } ?>
                    ...
                    <div class="combo valign-wrapper">
                        <h2>
                            ...
                            <span tooltip="<?php echo __( 'This profile is Not verified' );?>" flow="down">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="#e18805"
                                        d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M17,15.59L15.59,17L12,13.41L8.41,17L7,15.59L10.59,12L7,8.41L8.41,7L12,10.59L15.59,7L17,8.41L13.41,12L17,15.59Z" />
                                </svg>
                            </span>
                            <?php } ?>
                        ...
                        <a class="user_btn" href="<?php echo $site_url;?>/settings/<?php echo $profile->username;?>"
                            data-ajax="/settings/<?php echo $profile->username;?>"><?php echo __( 'Edit' );?></a>
                    </div>
                    <?php if( $profile->country !== '' ){?>
                    <p class="valign-wrapper"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <path fill="#8BC34A"
                                d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" />
                        </svg> <?php echo $profile->country_txt;?></p>
                    <?php } ?>
                    <div class="dt_user_likes">
                        <ul>
                            <li><a href="<?php echo $site_url;?>/likes" data-ajax="/likes" id="mylikesx"
                                    class="waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <path fill="#f25e4e"
                                            d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z" />
                                    </svg> <span class="bold"><?php echo $likes_count;?></span>
                                    <?php echo __( 'Likes' );?></a></li>
                            <li><a href="<?php echo $site_url;?>/visits" data-ajax="/visits" id="myViewsx"
                                    class="waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <path fill="#673ab7"
                                            d="M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z" />
                                    </svg> <span class="bold"><?php echo $views_count;?></span>
                                    <?php echo __( 'Views' );?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <figure class="dt_cover_photos">
                    <div class="dt_cp_photos_list">
                        <div class="dt_cp_bar_add_photos"
                            onclick="document.getElementById('avatar_profileimg').click(); return false">
                            <!-- Add Photo -->
                            <div class="inline">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                        ...
                        <?php if($role == 'vendor')
                        {
                            ...
                            $col=mysqli_query($con,"SELECT amount,pro_plan FROM payments where user_id=$id");
                                    ...
                                    // echo "<script>alert($pro_plan)</script>"; 
                                     }
                                     if($amount == '50')
                                     {
                                 //       echo "<script>alert('in 1')</script>"; 
                                     //echo "<script>alert('$id')</script>"; 
                                     $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND amount='50'");
                                     while($row2 = mysqli_fetch_assoc($col)){  
                                     $date = $row2['date'];
                                     $exdate=date('yy-m-d', strtotime($date. ' + 7 days')); 
                                     //echo "<script>alert('$exdate')</script>"; 
                                     $cr= date("Y-m-d") . "<br>";
                                     if($exdate <= $cr)
                                     {
                                         $sql = "DELETE FROM `payments` WHERE  user_id=$id AND amount='50'";
                                        $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
 
                                          if (mysqli_query($con, $sql) && mysqli_query($con, $update)) {
                                            echo '<script>alert("Please RENEW PLAN")</script>'; 
                                         } 
                                        }
                                    }
                                }
                                         else if($amount == '80')
                                         {
                                            //echo "<script>alert('in 1')</script>"; 
                                         //echo "<script>alert('$id')</script>"; 
                                         $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND amount='80'");
                                         while($row2 = mysqli_fetch_assoc($col)){  
                                         $date = $row2['date'];
                                         $exdate=date('yy-m-d', strtotime($date. ' +  7 days')); 
                                         //echo "<script>alert('$exdate')</script>"; 
                                         ...
                                         if($exdate <= $cr)
                                         {
                                             $sql = "DELETE FROM `payments` WHERE  user_id=$id AND amount='80'";
                                            $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
                                    ...
                                    else if($amount == '100')
                                    {
                                       //echo "<script>alert('in 1')</script>"; 
                                    //echo "<script>alert('$id')</script>"; 
                                    $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND amount='100'");
                                    while($row2 = mysqli_fetch_assoc($col)){  
                                    $date = $row2['date'];
                                    $exdate=date('yy-m-d', strtotime($date. ' + 1 months')); 
                                    //echo "<script>alert('$exdate')</script>"; 
                                    $cr= date("Y-m-d") . "<br>";
                                    if($exdate <= $cr)
                                    {
                                        $sql = "DELETE FROM `payments` WHERE  user_id=$id AND amount='100'";
                                       $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
                            ...
                            ?>
                        <div class="dt_cp_bar_add_videos"
                            onclick="$('#upload_video').modal('open');$('#btn_video_upload').removeClass('hide');$('#video_form').hide();">
                            <!-- Add Photo -->
                            <div class="inline">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="currentColor"
...
//                                          echo '    <source src="https://www.html5rocks.com/en/tutorials/video/basics/Chrome_ImF.ogv" type="video/ogg">';
						...
						?>
                        <input type="file" id="avatar_profileimg" class="hide"
                            accept="image/x-png, image/gif, image/jpeg" name="profile_images" multiple="multiple">
                    </div>
                </figure> <!-- End Cover -->
            </div>
                ...
                <div class="dt_user_about">
                    ...
                    <div class="about_block">
                        ...
                        <h4>
                            ...
                            <span><a class="edit_link"
                                    href="<?php echo $site_url;?>/settings-profile/<?php echo $profile->username;?>"
                                    data-ajax="/settings-profile/<?php echo $profile->username;?>"><?php echo __( 'Edit' );?></a></span>
                        </h4>
                    ...
                    <div class="about_block">
                        ...
                        <div class="location_map">
                            <img src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo urlencode($profile->location);?>&zoom=13&size=600x205&maptype=roadmap&key=AIzaSyBFZHfyVXQ0H1Fh30rrZEOUgAi55_zYbZE"
                                alt="<?php echo __( 'Location' );?>" />
                        </div>
                    </div>
                    <?php } ?>
        ...
        ?>
                    ...
                    <div class="vew_profile">
                        <div class="bs-example">
                            <a href="#Geeks2" class="btn btn-lg btn-primary waves-effect" data-toggle="modal">View
                                Video</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <video src='<?php echo $location; ?>' id='Geeks3' controls loop
...
?> <div class="about_block">
                            ...
                            <div class="dt_profile_info">
                                ...
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    </svg> <?php echo __( 'Personality' );?></h5>
                                <?php } ?>
    ...
    <a href="javascript:void(0);" class="btn-floating btn-large waves-effect waves-light bg_gradient only-mobile"
        style="bottom: 100px;position: fixed;right: 32px;"
        onclick="document.getElementById('avatar_profileimg').click(); return false">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-7 -6 40 40">
            <path fill="currentColor"
                d="M5,3A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H14.09C14.03,20.67 14,20.34 14,20C14,19.32 14.12,18.64 14.35,18H5L8.5,13.5L11,16.5L14.5,12L16.73,14.97C17.7,14.34 18.84,14 20,14C20.34,14 20.67,14.03 21,14.09V5C21,3.89 20.1,3 19,3H5M19,16V19H16V21H19V24H21V21H24V19H21V16H19Z">
            </path>
        </svg>
    ...
    <div id="upload_video" class="modal" style="width: 60%;">
        <div class="modal-content">
            ...
            <a href="javascript:void(0);" id="btn_video_upload"
                onclick="document.getElementById('avatar_profilevideo').click(); return false"
                class="btn_upld_prf_vid waves-effect">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z"></path>
                </svg> <?php echo __( 'Upload' );?>
            </a>
            ...
            <div id="video_form" class="hide">
                ...
                <div class="item active form-group">
                    ...
                    <img id="video_thumbnail_image" src="<?php echo $config->uri;?>/upload/photos/video-placeholder.jpg"
                        class="dt_prof_upldd_vid_thmb"
                        onclick="document.getElementById('video_thumbnail').click(); return false">
                    <input type="file" id="video_thumbnail" class="hide" accept="image/x-png, image/gif, image/jpeg"
        ...
        <div class="modal-footer">
            ...
            <button class="waves-effect waves-light btn-flat btn_primary white-text" disabled id="btn-upload-video-file"
                data-selected=""><?php echo __( 'Upload' );?></button>

        </div>
        <br><br>
        <h4> NOTE: Video size must be below 2MB and it must be in MP4.</h4>
    </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn-upload-video-file', function(e) {
            ...
            if (typeof $('#video_thumbnail')[0].files[0] !== "undefined") {
                formData.append("video_thumbnail", $('#video_thumbnail')[0].files[0], $(
                    '#video_thumbnail')[0].files[0].value);
            }
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.status == 200) {
                        ...
                        setTimeout(function() {
                            $("#ajaxRedirect").attr("data-ajax", '/' + window
                                .loggedin_user);
                            $("#ajaxRedirect").click();
                        }, 500);
        ...
        $(document).on('change', '#avatar_profilevideo', function(e) {
            ...
            php
            if ($profile - > is_pro == '0') {
                $user_image_count = (int) $db - > where('user_id', $profile - > id) - > getValue(
                    'mediafiles', 'count(id)');
                ...
                if ($user_image_count >= $config_max_image) {
                    ...
                    M.toast({
                        html: '<?php echo __('
                        You reach to limit of media uploads.
                        ');?>'
                    });
                    $('#upload_video').modal('close');
                    return false; <
	...
	?>
        <div class="home-announcement">
            <div class="alert alert-success" style="background-color: white;">
                <span class="close announcements-option" data-toggle="tooltip"
                    onclick="Wo_ViewAnnouncement(<?php echo $announcement['id']; ?>);" title="<?php echo __('Hide');?>"
                ...
                <div class="bg_gradient dt_home_filters_prnt">
                    <div class="dt_home_filters">
                        <div class="valign-wrapper dt_home_filters_head">
                            <p><span id="gender"><?php echo $_gender_text;?></span> <?php echo __('who ages');?> <span
                                    id="age_from"><?php echo $_age_from;?></span>-<span
                                    id="age_to"><?php echo $_age_to;?></span> <?php echo __('located within');?> <span
                                    id="located"><?php echo $_located;?></span> <?php echo $config->default_unit;?>
                                <!--<span id="location"><?php echo ($_location == '') ? '. . .' : $_location;?></span>-->
                            </p>
                                    ...
                                    <div id="basic" class="col s12 active search_filters">
                                        <form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
                                            <div class="row">
												...
												?>
                                                    <p><label><input type="checkbox" class="_gender filled-in"
                                                                value="<?php echo implode($all_gender,",");?>"
                                                                data-vx="_all_" data-txt="<?php echo __('All');?>"
                                                                <?php echo $all_checked;?> /><span
                                                                <?php if( empty($_gender)){ echo 'style="color: #c649b8;font-weight: 500;"'; }?>><?php echo __('All');?></span></label>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col s12 m4 valign-wrapper dt_hm_filtr_loc">
                                                    <label title="<?php echo __('My location');?>">
                                                        <input type="checkbox" class="filled-in"
                                                            <?php if($active_show_me_to == '' || $active_show_me_to == $profile->country){ ?>checked="checked"
                                                            <?php }?> id="is_my_location">
                                                        <b><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24">
                                                                <path fill="currentColor"
                                                                    d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z" />
                                                            </svg></b>
                                                    </label>
                                                    <select id="my_country" name="my_country"
                                                        data-country="<?php echo $profile->country;?>"
                                                        <?php if( $profile->show_me_to == $profile->country || $profile->show_me_to === '') {?>disabled="disabled"
                                                        <?php }?>>
                                                        <option value="" disabled selected>
                                                            <?php echo __( 'Choose your country' );?></option>
                                                        <?php
                                                    ...
                                                    <div class="row r_margin">
                                                        <div class="input-field col s6">
                                                            <select class="_age_from">
                                                                ...
                                                                <option value="<?php echo $i;?>"
                                                                    <?php if( $i == $_age_from){ echo 'selected';}?>>
                                                                    <?php echo $i;?></option>
                                                                <?php }?>
                                                            </select>
                                                        </div>
                                                        <div class="input-field col s6">
                                                            <select class="_age_to">
                                                                <?php for($i = 51 ; $i < 99 ; $i++ ){?>
                                                                <option value="<?php echo $i;?>"
                                                                    <?php if( $i == $_age_to){ echo 'selected';}?>>
                                                                    <?php echo $i;?></option>
                                                                <?php }?>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col s12 m3">
                                                    ...
                                                    ?>
                                                        <input type="range" min="1" max="50"
                                                            value="<?php echo $_located;?>" id="_located"
                                                            <?php if( $disable_bar) {?>disabled="disabled" <?php }?>
                                            ...
                                            <div class="btn_wrapper valign-wrapper">
                                                <button
                                                    class="btn waves-effect btn_glossy btn-flat btn-large waves-light btn-find-matches-search"
                                                    type="button"
                                                    id="btn_search_basic"><?php echo __('Search');?></button>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
                                            ...
                                            <div class="btn_wrapper valign-wrapper">
                                                <button
                                                    class="btn waves-effect btn_glossy btn-flat btn-large waves-light btn-find-matches-search"
                                                    id="btn_search_looks"
                                                    type="button"><?php echo __('Search');?></button>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col s12 m4">
                                                    ...
                                                    <div class="input-field">
                                                        <input placeholder="<?php echo __('e.g., Singing');?>"
                                                            id="interest" type="text" class="validate">
                                                        <script>
                                                        (function() {
                                                            document.addEventListener('DOMContentLoaded',
                                                                function() {
                                                                    var _elems = document.querySelectorAll(
                                                                        '#interest');
                                                                    var _instances = M.Autocomplete.init(
                                                                        _elems, {
...
//echo $guest;
include("config.php");
$sql=mysqli_query($con,"SELECT id,role from users where username='$guest'");
						  while($row=mysqli_fetch_assoc($sql))
								{
									$role=$row['role'];
									$id=$row['id'];
                                ...
                                echo "<br>"."vendorlogin";
                                    ...
                                    // echo "<script>alert($pro_plan)</script>"; 
                                     ...
                                     if($pro_plan == '1')
                                     {
                                        //echo "<script>alert('in 1')</script>"; 
                                     //echo "<script>alert('$id')</script>"; 
                                     $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND pro_plan='1'");
                                     while($row2 = mysqli_fetch_assoc($col)){  
                                     $date = $row2['date'];
                                     $exdate=date('yy-m-d', strtotime($date. ' + 7 days')); 
                                     //echo "<script>alert('$exdate')</script>"; 
                                     ...
                                     if($exdate <= $cr)
                                     {
                                         $sql = "DELETE FROM `payments` WHERE  user_id=$id AND pro_plan='1'";
                                        $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
                               ...
                               {
                                //    echo "<script>alert('in 2')</script>"; 
                                //  echo "<script>alert('$amount')</script>"; 
                                   $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND pro_plan='2'");
                                   while($row2 = mysqli_fetch_assoc($col)){  
                                   $dated = $row2['date'];
                                  // echo "<script>alert('$dated')</script>"; 
                                   $exdate=date('yy-m-d', strtotime($dated. ' + 1 months')); 
                                   //echo "<script>alert('$exdate')</script>"; 
                                   $cr= date("Y-m-d");
                                   //echo "<script>alert('$cr')</script>"; 
                                    if($exdate <= $cr)
                                    {
                                   $sql = "DELETE FROM `payments` WHERE  user_id=$id AND pro_plan='2'";
                                   $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
                                    ...
                                    {
                                       // echo "<script>alert('in 3')</script>"; 
                                       // echo "<script>alert('$amount')</script>"; 
                                        $col=mysqli_query($con,"SELECT date FROM payments where user_id=$id AND pro_plan='3'");
                                        while($row2 = mysqli_fetch_assoc($col)){  
                                        $dated = $row2['date'];
                                        $exdate=date('yy-m-d', strtotime($dated. ' + 1 year')); 
                                        $cr= date("Y-m-d");
                                        if($exdate <= $cr)
                                        {
                                        $sql = "DELETE FROM `payments` WHERE  user_id=$id AND pro_plan='3'";
                                        $update=" UPDATE `users` SET `pro_time` = '', `is_pro` = '0', `pro_type` = '' WHERE `users`.`id` = $id";
                ...
                <div id="section_match_users" class="<?php echo $match_style;?>">
                    ...
                    <div class="mtc_usr_avtr" id="avaters_item_container">
                        ...
                        <?php
							...
							$sql  = mysqli_query($con, "SELECT * from vendorpremium");
							while($row = mysqli_fetch_assoc($sql)){
								$silver = $row['silver'];
								$sv="silver";
								$silver = $sv;
                        ...
                        while($row = mysqli_fetch_assoc($sql)){
                            ...
                            //echo $amount;
                                ...
                                else if( $amount == 100)
                                {
                                    ...
                                    $premium="Normal Vendor";
                                }
                            
                           
                             ?>
                        <a href="<?php echo $site_url;?>/@<?php echo $username;?>"
                            data-ajax="/@<?php echo $username;?>">
                            <div class="item">
                                <span class="videoContainer">
                                    <img src="<?php echo $location; ?>" alt="<?php echo $username;?>"
                                        class=" over  xvendor">
                                </span>
                                <?php echo $username;?> <?php echo $premium;?>
                        </a>
...
//             $col=mysqli_query($con,"SELECT date FROM payments where pro_plan='1'");
//                      while($row2 = mysqli_fetch_assoc($col)){  
//                      $date = $row2['date'];
//      echo $date;
//      echo "<br>";
//      echo $exdate=date('yy-m-d', strtotime($date. ' + 7 days')); 
//      echo "<br>";
//      echo $cr= date("Y-m-d") . "<br>";
// if($exdate <= $cr)
// {
//     echo "reniew";
// }
//     }
//     echo "<br>";
//     echo "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjj";
//     $col=mysqli_query($con,"SELECT date FROM payments where pro_plan='2'");
//     while($row2 = mysqli_fetch_assoc($col)){  
//     $date = $row2['date'];
// echo "<br>";
// echo $date;
// echo "<br>";
// echo $exdate=date('yy-m-d', strtotime($date. ' + 1 months')); 
// echo $final;
// echo "<br>";
...
// $col=mysqli_query($con,"SELECT date FROM payments where pro_plan='3'");
// while($row2 = mysqli_fetch_assoc($col)){  
// $date = $row2['date'];
// echo "<br>";
// echo $date;
// echo "<br>";
// echo $exdate=date('yy-m-d', strtotime($date. ' + 1 year')); 
// echo $final;
// echo "<br>";
...
?>
            ...
            <a href="javascript:void(0);" style="display: none;" id="btn_load_more_match_users"
                data-lang-loadmore="<?php echo __('Load more...');?>"
                data-lang-nomore="<?php echo __('No more users to show.');?>" data-ajax-post="/loadmore/match_users"
                data-ajax-params="page=2" data-ajax-callback="callback_load_more_match_users"
            ...
            <div class="dt_ltst_users hide" id="latest_user">
                <div class="dt_home_rand_user">
                    ...
                    <a href="javascript:void(0);" id="btn_load_more_search_users"
                        data-lang-more="<?php echo __('Load more...');?>"
                        data-lang-nomore="<?php echo __('No more users to show.');?>"
                        data-ajax-post="/loadmore/find_matches" data-ajax-params="page=2"
                        data-ajax-callback="callback_load_more_search_users"
                        class="btn waves-effect load_more hide"><?php echo __('Load more...');?></a>
                </div>
            </div>
        </div>
        <!-- End Search Users  -->
...
function Wo_ViewAnnouncement(id) {
    ...
    $.get(window.ajax + 'useractions/UpdateAnnouncementViews', {
        id: id
    }, function(data) {
        if (data.status == 200) {
