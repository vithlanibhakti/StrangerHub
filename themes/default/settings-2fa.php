        ...
        <form method="post" action="/profile/save_twofactor_setting" class="col s12 m6" id="twofactor_settings">
            ...
            <div class="row">
                <div class="input-field col s12 xs12">
                    <label for="facebook"><?php echo __( 'Two-factor authentication' );?></label>
                </div>
            </div>
            ...
            <p>
                <?php echo __("Turn on 2-step login to level-up your account's security, Once turned on, you'll use both your password and a 6-digit security code sent to your phone or email to log in.");?>
            </p>
            <hr>
