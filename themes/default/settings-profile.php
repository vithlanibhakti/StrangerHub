    ...
    <div class="container">
        ...
        <div class="sett_navbar valign-wrapper">
            <ul class="tabs">
                ...
                <li class="tab col s3"><a class="active" href="<?php echo $site_url;?>/settings-profile/<?php echo $profile->username;?>" data-ajax="/settings-profile/<?php echo $profile->username;?>" target="_self"><?php echo __( 'Profile' );?></a></li>
