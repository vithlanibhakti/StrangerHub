    ...
    <div class="container">
        ...
        <div class="sett_navbar valign-wrapper">
            <ul class="tabs">
                ...
                <li class="tab col s3"><a class="active" href="<?php echo $site_url;?>/settings-affiliate/<?php echo $profile->username;?>" data-ajax="/settings-affiliate/<?php echo $profile->username;?>" target="_self"><?php echo __( 'My affiliates' );?></a></li>
        ...
        <form class="col s12 m6">
			<div class="dt_usr_affl">
				<h2 class="valign-wrapper">
					...
					<a class="btn btn-small waves-effect waves-light btn_primary btn_round" href="<?php echo $site_url;?>/settings-payments/<?php echo $profile->username;?>" data-ajax="/settings-payments/<?php echo $profile->username;?>"><?php echo __('Request withdrawal');?></a>
				</h2>
				...
				<div class="row">
					...
					<div class="col l8">
						<div class="input-field">
							<input type="text" readonly onclick="this.select();" value="<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>">
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col l8">
						<div class="social-btn-parent">
							<a href="https://twitter.com/intent/tweet?text=<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>" target="_blank">
							...
							<a rel="publisher" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>" target="_blank">
							...
							<a href="https://api.whatsapp.com/send?text=<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>" data-action="share/whatsapp/share" target="_blank">
							...
							<a href="https://pinterest.com/pin/create/button/?url=<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>" target="_blank">
							...
							<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $site_url;?>/register?ref=<?php echo $profile->username;?>" target="_blank">
